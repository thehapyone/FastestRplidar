...
/*
    ...
    * */
    ...
    // Set the board rate, this should pass through a function
    opt_com_path = "/dev/ttyUSB0";
    ...
    while (1) {
        ...
        if (IS_OK(op_result)) {
            ...
            // We should only grab scan data with a non zero quality  
